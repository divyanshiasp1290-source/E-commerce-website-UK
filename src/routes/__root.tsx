    ...
    <div className="flex min-h-[70vh] items-center justify-center px-4">
      <div className="max-w-md text-center">
        ...
        <p className="mt-2 text-sm text-muted-foreground">
          Please try again — we've logged the issue.
        </p>
...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { title: "LunadiGroup — Cocoa, Coffee, Nuts more Exporter" },
      { name: "description", content: "Global wholesale supplier of premium cocoa, coffee beans, cashew kernels, and more — sourced at origin, shipped worldwide." },
      { name: "author", content: "LunadiGroup" },
      { property: "og:title", content: "LunadiGroup — Premium Agricultural Commodity Exporter" },
      { property: "og:description", content: "Cocoa · Coffee · Nuts · Grains · Seeds — export-grade commodities from origin to buyer." },
